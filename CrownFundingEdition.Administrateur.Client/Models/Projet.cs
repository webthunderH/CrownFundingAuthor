...
namespace CrownFundingEdition.Administrateur.Client.Models
{
    public class Projet
    {
        ...
        public Projet(int ID, string Titre, string Sous_Titre, string Nom, DateTime DateDebut, DateTime DateFin, bool Historique, int J_aime, int Je_n_aime_Pas, int Total_Dons, int Total_Crownfunding)
        {
            this.ID = ID;
            this.Titre = Titre;
