...
{
    public class VUtilisateur
    {
        private int _Id, _Ad_Numero;
        private string _Nom, _Prenom, _Pseudo, _Password, _Adresse, _Pays, _Email, _Compte_bancaire, _Statut, _Ad_Rue, _Ad_Ville, _Ad_Code_Post;
        ...
        public VUtilisateur(int Id, string Nom, string Prenom, string Pseudo, string Password, string Adresse, string Pays, string Email, string Compte_bancaire, string Statut)
        {
            this.Id = Id;
            this.Nom = Nom;
            this.Prenom = Prenom;
